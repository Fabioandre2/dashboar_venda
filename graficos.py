...
grafico_rec_estado = px.bar(
    # Recupera os 7 maiores registros. (head, retorna os maiores registros. tail, retorna os menores registros )
...
grafico_rec_categoria.update_layout(yaxis_title = 'Valores')
...
grafico_vend_vendedores = px.bar(
...
grafico_vend_vendedores.update_layout(yaxis_title = 'Vendedores')